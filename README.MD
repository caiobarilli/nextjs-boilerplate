...
```sh
yarn create next-app -e https://github.com/caiobarilli/nextjs-boilerplate/tree/main/app_router/eslint-prettier frontend
```
...
```sh
yarn create next-app -e https://github.com/caiobarilli/nextjs-boilerplate/tree/main/app_router/jest-eslint-prettier frontend
```
...
```sh
yarn create next-app -e https://github.com/caiobarilli/nextjs-boilerplate/tree/main/app_router/jest-styled-components frontend
```
...
```sh
yarn create next-app -e https://github.com/caiobarilli/nextjs-boilerplate/tree/main/app_router/jest-tailwind frontend
```
